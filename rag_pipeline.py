...
def build_or_load_vectorstore(pdf_path: str, persist_dir: str):
    ...
    # Disable Chroma telemetry to avoid noisy capture() errors
...
def build_chain():
    ...
    prompt_template = """Usa SOLO el siguiente contexto para responder la pregunta. Si no está en el contexto, responde: "No lo sé con la información disponible."
Contexto: {context}
Pregunta: {question}
Respuesta:"""
